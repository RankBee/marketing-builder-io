          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-purple-50 to-white rounded-lg border border-purple-200 p-8">
              ...
              <ul className="text-black mb-6 space-y-2">
                <li className="font-bold">Increase visibility in AI-generated answers.</li>
                <li className="font-bold">Protect traffic and brand presence as clicks decline.</li>
                <li className="font-bold">Move faster than competitors still optimising only for Google's blue links.</li>
              </ul>
            </div>
