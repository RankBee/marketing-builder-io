      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {/* RankBee Toolkit */}
            <div className="bg-gradient-to-br from-purple-50 to-white rounded-3xl border border-purple-200 p-6 sm:p-8 flex flex-col gap-4 hover:shadow-lg transition-shadow duration-300 [animation:shimmer_2s_ease-in-out_infinite]" style={{borderImage: 'linear-gradient(to right, rgb(147, 51, 234), rgb(244, 114, 182), rgb(147, 51, 234)) 1', backgroundSize: '200% 100%'}}>
