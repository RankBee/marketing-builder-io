        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start" >
            ...
            <div className="flex-1 lg:max-w-xl" >
              ...
              <div className="description-box bg-white/80 backdrop-blur-sm p-4 sm:p-6 rounded-lg mb-8 border border-purple-200">
              ...
              <div className="flex flex-col gap-3 items-start w-full">
                <div className="detail-box bg-purple-100 rounded-xl px-8 py-3 flex items-center gap-3">
            ...
            <div className="calendly-container w-[400px]">
              {calendlyUrl && (
                <>
                  ...
                  `}</style>
                  <div
                    className="calendly-inline-widget rounded-2xl shadow-xl bg-white"
