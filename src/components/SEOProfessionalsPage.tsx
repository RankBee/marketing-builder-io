        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 sm:space-y-8">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight tracking-tight max-w-5xl mx-auto">
              SEO and Brand <span className="relative inline-block px-1" style={{
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Optimize your brand's visibility across AI search engines. Rank higher in ChatGPT, Claude, and Gemini while protecting your organic search presence.
            </p>
